...
> 服务端的详细建设方案(挑战、接口字段完整版、Java 技术架构、集群分层、声纹算法与库管理、ASR 引入)见 **[`docs/回铃音检测平台-服务端建设方案-Java版.md`](./回铃音检测平台-服务端建设方案-Java版.md)**。
...
| [`docs/回铃音检测平台-服务端建设方案-Java版.md`](./回铃音检测平台-服务端建设方案-Java版.md) | 服务端专项(Java 版):挑战、接口字段完整版、技术架构、集群分层、声纹算法与库管理、ASR 引入 |
| [`docs/回铃音检测平台-服务端建设方案-Rust版.md`](./回铃音检测平台-服务端建设方案-Rust版.md) | 服务端专项(Rust 版):同结构 + Java vs Rust 优缺点对比 |
| [`docs/回铃音检测平台-服务端建设方案-Python版.md`](./回铃音检测平台-服务端建设方案-Python版.md) | 服务端专项(Python 版):复用现有 `server/` + Java vs Python 优缺点对比 |
| [`docs/声纹库与声纹匹配-算法实现原理.md`](./声纹库与声纹匹配-算法实现原理.md) | 通用算法技术文档:主流/前沿方案、实现原理、关键数据结构与算法、语言对比 |
| [`docs/声纹库建设-详细技术文档.md`](./声纹库建设-详细技术文档.md) | 声纹库建设:音频/标签准备、预处理、特征提取、归一化、存储建索引、运营维护 |
